...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/v1/available-timeslots").hasRole("SCHEDULE_MAKER")
                .antMatchers("/api/v1/available-teachers").hasRole("SCHEDULE_MAKER")
                .antMatchers("/api/v1/available-classrooms").hasRole("SCHEDULE_MAKER")
